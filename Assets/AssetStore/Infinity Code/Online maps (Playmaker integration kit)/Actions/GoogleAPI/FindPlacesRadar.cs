...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class FindPlacesRadar : FsmStateAction
    {
        ...
        private void DoEnter()
        {
            ...
            OnlineMapsTextWebService query = OnlineMapsGooglePlaces.FindRadar(coordinates.Value, radius.Value, 
                googleApiKey.Value, keywordValue, nameValue, typesValue, minPriceValue, maxPriceValue, openNowValue);
